...
def normilized_dlt(point_list1,point_list2,debug=False):
	...
	if debug is True:
		print('T\':',T_)
		print('centroid:',np.mean(point_list2,axis=0))
		print('mean_distance:',np.mean(np.linalg.norm(point_list2[:,:2],axis=1)))
		print(point_list2)
